...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.example.clientasmtoi1510.service.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://localhost:9000/HelloWorld";
    ...
    public com.example.clientasmtoi1510.service.HelloWorld getHelloWorldPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.clientasmtoi1510.service.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.clientasmtoi1510.service.HelloWorldPortBindingStub _stub = new com.example.clientasmtoi1510.service.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.clientasmtoi1510.service.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.clientasmtoi1510.service.HelloWorldPortBindingStub _stub = new com.example.clientasmtoi1510.service.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://example/", "HelloWorldPort"));
        }
